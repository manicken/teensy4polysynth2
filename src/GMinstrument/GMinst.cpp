...
const PROGMEM AudioSynthWavetable::instrument_data * GMinst[] = {
    ...
    &AccordionFr,
    &AccordionFr, //&Harmonica,
    &AccordionFr, //&Bandoneon,
    &NylonstrGt,
    ...
    &Violin, //&Cello,
    &Contrabass,
    &Contrabass, //&TremoloStr,
    &Contrabass, //&PizzicatoStr,
    &Contrabass, //&Harp,
    &Contrabass, //&SynthDrum, // should be timpani
    &Contrabass, //&Strings,
    &Contrabass, //&SlowStrings,
    &Contrabass, //&SynStrings1,
    &Contrabass, //&SynStrings2,
    &ChoirAahs,
    &VoiceOohs,
    &SynVox,
    &OrchestraHit,
    ...
    &Shanai, //&Agogo,
    &Shanai, //&SteelDrums,
    &Shanai, //&SynthDrum, // woodblock
    &Shanai, //&Taiko,
    &Shanai, //&MeloTom1,
    &Shanai, //&SynthDrum,
    &Shanai, //&ReverseCym,
    &Shanai, //&SynthDrum, // gt fret noise
    &Shanai, //&BreathNoise,
    &Shanai, //&Seashore,
    &Shanai, //&Bird,
    &Shanai, //&Telephone1,
